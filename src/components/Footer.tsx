    ...
    <footer className="bg-gray-800 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-4">EntrepreneurConnect</h3>
            <p className="text-gray-300 text-sm">
              La plateforme dédiée à la connexion et au soutien des entrepreneurs français.
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300 text-sm">
              <li>contact@entrepreneurconnect.fr</li>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center text-sm text-gray-400">
          <p>© {new Date().getFullYear()} EntrepreneurConnect. Tous droits réservés.</p>
        </div>
      </div>
    </footer>
  );
